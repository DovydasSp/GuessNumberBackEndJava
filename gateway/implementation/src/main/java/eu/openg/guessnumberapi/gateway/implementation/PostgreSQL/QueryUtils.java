...
class QueryUtils {
    ...
    static final String INSERT_GAME_QUERY = "INSERT INTO " + TABLE_NAME + " (" + GUESS_COUNT + "," + ACTUAL_NUMBER + ") " +
            "VALUES (?,?) RETURNING *;";

    static final String UPDATE_GUESSCOUNT_QUERY = "UPDATE " + TABLE_NAME + " SET " + GUESS_COUNT + " = " + GUESS_COUNT + " + 1 " +
